...
plt.legend()
plt.savefig("/nfs/Images/abos_"+ usernames[0][0] +".png")
...
plt.legend()
plt.savefig("/nfs/Images/abos_"+ usernames[1][0] +".png")
hist.append(abos_jdg[-1])
...
plt.legend()
plt.savefig("/nfs/Images/abos_"+ usernames[2][0] +".png")
hist.append(abos_jdg[-1])
...
plt.legend()
plt.savefig("/nfs/Images/abos_"+ usernames[3][0] +".png")
hist.append(abos_jdg[-1])
